...
Pickup_Bandolier(edict_t *ent, edict_t *other)
{
	...
	if (other->client->pers.max_bullets < 999)
	{
		other->client->pers.max_bullets = 999;
	}

	if (other->client->pers.max_shells < 999)
	{
		other->client->pers.max_shells = 999;
	}

	if (other->client->pers.max_cells < 999)
	{
		other->client->pers.max_cells = 999;
	}

	if (other->client->pers.max_slugs < 999)
	{
		other->client->pers.max_slugs = 999;
	}
...
Pickup_Pack(edict_t *ent, edict_t *other)
{
	...
	if (other->client->pers.max_rockets < 999)
	{
		other->client->pers.max_rockets = 999;
	}

	if (other->client->pers.max_grenades < 999)
	{
		other->client->pers.max_grenades = 999;
	}
